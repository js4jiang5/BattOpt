...
### 🌍 스크린샷 &nbsp;[(상세 매뉴얼)](https://battopt.buddha-path.top/manual_kr.html)
**BattOpt**는 직관적인 GUI와 강력한 CLI를 결합한 설계를 갖추고 있습니다. 위치 기반 **영역(Zone)** 설정을 통해 집, 직장, 여행지에 따라 충전 제한을 별도로 구성할 수 있습니다.
[![한국어 GUI](assets/screenshots/kr/gui-limit-home.png)](https://battopt.buddha-path.top/manual_kr.html)
...
설치 직후 모든 사용자는 Pro 기능을 **30일 동안 무료로 체험**할 수 있습니다. 체험 시작을 위해 신용카드 정보를 입력할 필요가 없습니다.
...
* **ⓘ** 아이콘을 클릭하고 「**최적화된 배터리 충전**」을 **끕니다**. macOS 26.4 이상인 경우 「**충전 한도**」를 **100%**로 설정하십시오.
...
## 📃 면책 조항
BattOpt는 Mac의 배터리 상태를 관리하기 위해 저수준 시스템 호출을 사용합니다. M1 및 이전 Intel MacBook에서 광범위하게 테스트되었으나, 본 소프트웨어는 어떠한 보증 없이 "있는 그대로 (AS IS)" 제공되며, 향후 macOS 버전에 대한 지원은 보장되지 않습니다.
