...
[![GUI на русском](assets/screenshots/ru/gui-limit-home.png)](https://battopt.buddha-path.top/manual_ru.html)
...
Все пользователи получают **30-дневную бесплатную пробную версию** функций Pro сразу после установки. Для начала работы кредитная карта не требуется.
...
**[Купить и активировать Pro через Polar](https://buy.polar.sh/polar_cl_6lBz0uWJ9HA3a3tyFR1op9x6WBNTqSoqF8tge0XNcgu)**
...
* Нажмите на значок **ⓘ**, **выключите** «**Оптимизированную зарядку**» и установите **Лимит зарядки** на **100%** для macOS 26.4 или выше.
...
BattOpt использует низкоуровневые системные вызовы для управления состоянием аккумулятора вашего Mac. Несмотря на тщательное тестирование на MacBook с процессорами M1 и более старых моделях Intel, программа предоставляется на условиях «КАК ЕСТЬ» (AS IS) без каких-либо гарантий, а поддержка будущих версий macOS не гарантируется.
