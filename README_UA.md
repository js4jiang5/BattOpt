...
Усі користувачі отримують **30-денну безкоштовну пробну версію** функцій Pro відразу після встановлення. Для початку роботи кредитна картка не потрібна.
...
* Натисніть на значок **ⓘ**, **вимкніть** «**Оптимізоване заряджання**» та встановіть **Ліміт заряджання** на **100%** для macOS 26.4 або новішої.
...
BattOpt використовує низькорівневі системні виклики для керування станом акумулятора вашого Mac. Хоча програма була ретельно протестована на MacBook з процесорами M1 та старіших моделях Intel, вона надається на умовах «ЯК Є» (AS IS) без будь-яких гарантій, а підтримка майбутніх версій macOS не гарантується.
